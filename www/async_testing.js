...
import * as wasmArrow1 from "parquet-wasm/bundler/arrow1";
wasm.setPanicHook();
window.wasm = wasm;
...
async function readParquetFile() {
  ...
  const simulatedFile = new File([blobResult], '2-partition-brotli.parquet', {type: 'application/vnd.apache.parquet'})
